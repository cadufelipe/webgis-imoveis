...
import br.com.webgis.imovel.dto.ContagemDeLocalidade;
...
public interface ImovelRepository extends JpaRepository<Imovel, Long>, JpaSpecificationExecutor<Imovel> {
	 ...
	 */
	@Query("""
			SELECT new br.com.webgis.imovel.dto.ContagemDeLocalidade(i.endereco.uf, COUNT(i))
			FROM Imovel i
	...
	@Query("""
			SELECT new br.com.webgis.imovel.dto.ContagemDeLocalidade(i.endereco.municipio, COUNT(i))
			FROM Imovel i
