 ...
 */
final class ImovelMapper {

	private ImovelMapper() {
	}

	static Imovel converterParaEntidade(ImovelRequest req, Proprietario proprietario) {
	...
	static void aplicarEm(ImovelRequest req, Imovel imovel, Proprietario proprietario) {
	...
	static ImovelResponse converterParaResposta(Imovel imovel) {
	...
	static PontoNoMapaResponse converterParaPonto(Imovel imovel) {
		Endereco endereco = imovel.getEndereco();
		Coordenada coordenada = imovel.getCoordenada();
