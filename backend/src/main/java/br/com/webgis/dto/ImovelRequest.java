...
public record ImovelRequest(
		...
		/**
		 * CPF do proprietario, com ou sem pontuacao. **Obrigatorio.**
		 *
		 * E' ele quem identifica a pessoa: CPF ja cadastrado liga o imovel aquele
		 * proprietario, mesmo que o nome tenha vindo escrito de outro jeito, e
		 * nenhum registro novo e' criado.
		 *
		 * Exigi-lo aqui e' o que impede o cadastro de continuar crescendo com
		 * proprietarios que so' o nome identifica — e o que faz os anteriores a
		 * V9 receberem documento na primeira vez que ganham um imovel novo.
		 */
